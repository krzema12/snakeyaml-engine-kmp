...
class DumpWidthTest : FunSpec({
    ...
    test("split lines double quoted") {
        val dump = Dump(DumpSettings.builder().setSplitLines(true).setDefaultScalarStyle(ScalarStyle.DOUBLE_QUOTED).build())
        ...
        val dump2 = Dump(DumpSettings.builder().setSplitLines(false).setDefaultScalarStyle(ScalarStyle.DOUBLE_QUOTED).build())
        ...
        // setWidth
        val dump3 = Dump(DumpSettings.builder().setSplitLines(true).setWidth(15).setDefaultScalarStyle(ScalarStyle.DOUBLE_QUOTED).build())
    ...
    test("split lines single quoted") {
        val dump = Dump(DumpSettings.builder().setSplitLines(true).setDefaultScalarStyle(ScalarStyle.SINGLE_QUOTED).build())
        // Split lines enabled (default)
        var output = dump.dumpToString(data1)
        output shouldBe "'1111111111 2222222222 3333333333 4444444444 5555555555 6666666666 7777777777 8888888888\n  9999999999 0000000000'\n"
        ...
        // Split lines disabled
        val dump2 = Dump(DumpSettings.builder().setSplitLines(false).setDefaultScalarStyle(ScalarStyle.SINGLE_QUOTED).build())
    ...
    test("split lines folded") {
        val dump = Dump(DumpSettings.builder().setSplitLines(true).setDefaultScalarStyle(ScalarStyle.FOLDED).build())
        // Split lines enabled (default)
        var output = dump.dumpToString(data1)
        ...
        // Split lines disabled
        val dump2 = Dump(DumpSettings.builder().setSplitLines(false).setDefaultScalarStyle(ScalarStyle.FOLDED).build())
    ...
    test("split lines literal") {
        val dump = Dump(DumpSettings.builder().setSplitLines(true).setDefaultScalarStyle(ScalarStyle.LITERAL).build())
    ...
    test("split lines plain") {
        val dump = Dump(DumpSettings.builder().setSplitLines(true).setDefaultScalarStyle(ScalarStyle.PLAIN).build())
        // Split lines enabled (default)
        var output = dump.dumpToString(data1)
        output shouldBe "1111111111 2222222222 3333333333 4444444444 5555555555 6666666666 7777777777 8888888888\n  9999999999 0000000000\n"
        ...
        // Split lines disabled
        val dump2 = Dump(DumpSettings.builder().setSplitLines(false).setDefaultScalarStyle(ScalarStyle.PLAIN).build())
