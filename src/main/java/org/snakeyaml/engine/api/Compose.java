...
public class Compose {
    ...
    public Optional<Node> composeReader(Reader yaml) {
        return new Composer(new ParserImpl(new StreamReader(yaml, settings)), settings.getResolver()).getSingleNode();
    }
    ...
    public Optional<Node> composeInputStream(InputStream yaml) {
        return new Composer(new ParserImpl(new StreamReader(new YamlUnicodeReader(yaml), settings)), settings.getResolver()).getSingleNode();
    }
