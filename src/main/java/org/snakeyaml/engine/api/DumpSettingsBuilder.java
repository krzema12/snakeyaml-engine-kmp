...
public final class DumpSettingsBuilder {
     ...
     * @param indent - the number of spaces. Must be within the range org.snakeyaml.engine.emitter.Emitter.MIN_INDENT
     *               and org.snakeyaml.engine.emitter.Emitter.MAX_INDENT
     * @return the builder with the provided value
     */
    ...
    /**
     * Default is 0.
     * @param indicatorIndent - must be non-negative and less than org.snakeyaml.engine.emitter.Emitter.MAX_INDENT - 1
     * @return the builder with the provided value
     */
