 ...
 * comments here.
 */
public class ParserImplJava implements Parser {
   ...
   */
  public ParserImplJava(LoadSettings settings, StreamReader reader) {
   ...
   * @param scanner - input
   */
  public ParserImplJava(LoadSettings settings, Scanner scanner) {
