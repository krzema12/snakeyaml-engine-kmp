...
class MappingNodeTest {
    ...
    void toString(TestInfo testInfo) {
        ...
        assertTrue(representation.startsWith("<org.snakeyaml.engine.nodes.MappingNode (tag=tag:yaml.org,2002:map, values={ key=<org.snakeyaml.engine.nodes.ScalarNode (tag=tag:yaml.org,2002:str, value=a)>; value=<NodeTuple keyNode=<org.snakeyaml.engine.nodes.ScalarNode (tag=tag:yaml.org,2002:str, value=a)>; valueNode=<org.snakeyaml.engine.nodes.ScalarNode (tag=tag:yaml.org,2002:int, value=1)>> }{ key=<org.snakeyaml.engine.nodes.ScalarNode (tag=tag:yaml.org,2002:str, value=self)>;"));
