...
public class EmitterWithCommentEnabledTest {
    ...
    public void testCommentsInFlowMapping() {
        ...
        emitter.emit(new MappingStartEvent(Optional.empty(), Optional.of("yaml.org,2002:map"), true, FlowStyle.FLOW));
        emitter.emit(new CommentEvent(CommentType.BLOCK, " I'm first", Optional.empty(), Optional.empty()));
        ImplicitTuple allImplicit = new ImplicitTuple(true, true);
        emitter.emit(new ScalarEvent(Optional.empty(), Optional.of("yaml.org,2002:str"), allImplicit, "a", ScalarStyle.PLAIN, Optional.empty(), Optional.empty()));
        emitter.emit(new ScalarEvent(Optional.empty(), Optional.of("yaml.org,2002:str"), allImplicit, "Hello", ScalarStyle.PLAIN, Optional.empty(), Optional.empty()));
        emitter.emit(new ScalarEvent(Optional.empty(), Optional.of("yaml.org,2002:str"), allImplicit, "b", ScalarStyle.PLAIN, Optional.empty(), Optional.empty()));
        emitter.emit(new MappingStartEvent(Optional.empty(), Optional.of("yaml.org,2002:map"), true, FlowStyle.FLOW, Optional.empty(), Optional.empty()));
        emitter.emit(new ScalarEvent(Optional.empty(), Optional.of("yaml.org,2002:str"), allImplicit, "one", ScalarStyle.PLAIN, Optional.empty(), Optional.empty()));
        emitter.emit(new ScalarEvent(Optional.empty(), Optional.of("yaml.org,2002:str"), allImplicit, "World", ScalarStyle.PLAIN, Optional.empty(), Optional.empty()));
        emitter.emit(new CommentEvent(CommentType.BLOCK, " also me", Optional.empty(), Optional.empty()));
        emitter.emit(new ScalarEvent(Optional.empty(), Optional.of("yaml.org,2002:str"), allImplicit, "two", ScalarStyle.PLAIN, Optional.empty(), Optional.empty()));
        emitter.emit(new ScalarEvent(Optional.empty(), Optional.of("yaml.org,2002:str"), allImplicit, "eee", ScalarStyle.PLAIN, Optional.empty(), Optional.empty()));
    ...
    public void testCommentInEmptyFlowMapping() {
        ...
        emitter.emit(new DocumentStartEvent(false, Optional.empty(), new HashMap<>(), Optional.empty(), Optional.empty()));
        emitter.emit(new MappingStartEvent(Optional.empty(), Optional.of("yaml.org,2002:map"), true, FlowStyle.FLOW, Optional.empty(), Optional.empty()));
        emitter.emit(new CommentEvent(CommentType.BLOCK, " nobody home", Optional.empty(), Optional.empty()));
        emitter.emit(new MappingEndEvent(Optional.empty(), Optional.empty()));
        emitter.emit(new DocumentEndEvent(false, Optional.empty(), Optional.empty()));
        emitter.emit(new StreamEndEvent(Optional.empty(), Optional.empty()));
    ...
    public void testCommentInFlowSequence() {
        ...
        emitter.emit(new StreamStartEvent(Optional.empty(), Optional.empty()));
        emitter.emit(new DocumentStartEvent(false, Optional.empty(), new HashMap<>(), Optional.empty(), Optional.empty()));
        emitter.emit(new SequenceStartEvent(Optional.empty(), Optional.of("yaml.org,2002:seq"), true, FlowStyle.FLOW, Optional.empty(), Optional.empty()));
